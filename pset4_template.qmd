...
Now we calculate the # of hospitals per zip code in 2016 based on the previous step (note: we want all hospitals in 2016, not just the ones that were open in 2016 and closed in 2019):
