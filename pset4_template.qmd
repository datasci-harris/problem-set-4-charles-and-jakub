...
```{python}
import chardet
with open('other_data_Q3_2024.csv', 'rb') as f:
    result = chardet.detect(f.read())
print(result)  # Shows detected encoding
df = pd.read_csv('other_data_Q3_2024.csv', encoding=result['encoding'])
...
```{python}
import pandas as pd
df = pd.read_csv('other_data_Q3_2024.csv', encoding='Windows-1252', low_memory=False)
